...
1. If you used Cloud Shell, in the Azure portal select the **[>_]** button to open Cloud Shell, and run `rm -rf ~/<your-folder-name>` to delete the folder you created for this exercise.
