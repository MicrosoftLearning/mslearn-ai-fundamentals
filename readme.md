...
The AI-901 course includes Microsoft Foundry-based labs from this repo, *<u>and</u>* conceptual labs from <https://github.com/MicrosoftLearning/mslearn-ai-concepts>. In one-day deliveries, you're likely only to have time to include a subset of these labs; and we recommend the Foundry-based ones in the **this** repo. However, you may consider using the conceptual labs in tis repo as demo's, as additional further exploration for learners, or as fallback labs in the event of technical issues providing students with access to a functional Azure environment.
